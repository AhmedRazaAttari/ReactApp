...
function WatchLater(props) {
            ...
            if (user) {
                ...
                fetch("https://halelujjahgospellivestreaming.herokuapp.com/user/GetProfile", {
                    ...
                    if (!r.ok) {
                        ...
                        setUserWatchLaterVideos(data.user[0].WatchLater)
                        setIsloading(false)
    ...
    function RemoveFromWatchLater(items) {
        ...
        fetch("https://halelujjahgospellivestreaming.herokuapp.com/user/RemoveWatchLater", {
            method: "POST",
            headers: headers,
            body: JSON.stringify({
            ...
            if (!r.ok) {
                ...
                console.log("DONE")
                alert("Video is removed From watch later")
                Refresh()
            }
        }))
    }
    ...
    return (
        <div>
            ...
            <div style={{ display: "flex", flexDirection: "row", height: "100%", justifyContent: "center" }}>
                ...
                <div className="Gradient Sidebar" id="SidebarID" style={{ width: 230, height: '100%', position: "fixed", top: 0, left: 0, zIndex: 100 }}>
                    <ul>
                        ...
                        <li style={{ background: "linear-gradient(135deg, #826cfd 0%, #ff516b 100%)" }}><a><span><FontAwesomeIcon icon={faClock} style={{ marginRight: 15 }} color="white" /></span><Link style={{ color: "white", textDecoration: "none" }}>Watch Later</Link></a></li>
            ...
            <div style={{ width: "90%", margin: "0 auto", display: "flex", flexDirection: "column", padding: 30 }}>
                {!isloading && UserWatchLaterVideos.length ? UserWatchLaterVideos.map((items, i) => {
                    return <div style={{ display: "flex", cursor: "pointer", flexDirection: "row", width: "80%", margin: 7, marginTop: 15 }}>
                        ...
                        <div style={{ padding: 20, display: "flex", flexDirection: "column" }}>
                            ...
                            <Button variant="danger" onClick={() => RemoveFromWatchLater(items)} style={{ background: "#962c45", display: "flex", width: 260, justifyContent: "center", alignItems: "center", marginRight: 10 }}>REMOVE FROM WATCH LATER</Button>
                        </div>
                    </div>
