                    ...
                    if (!r.ok) {
                        ...
                        fetch("https://halelujjahgospellivestreaming.herokuapp.com/user/GetChannelProfile", {
                            ...
                            if (!r2.ok) {
                                ...
                                setChannelComments(data2.Channel[0].Comments)
                            }
                        }))
                    }
                }))
            ...
            <div style={{ display: "flex", flexDirection: "row" }}>
                ...
                <div className="Sidebar" style={{ width: '18%', boxShadow: "1px 2px 4px 0px #e2dada", height: '100vh', display: "flex", flexDirection: "column" }}>
                    ...
                    <ul>
                        ...
                        <li style={{ background: "linear-gradient(135deg, #ff516b 0%,#826cfd 100%)" }}><a><span><FontAwesomeIcon icon={faCommentAlt} style={{ marginRight: 15, fontSize: 17 }} color="white" /></span><Link style={{ color: "white", textDecoration: "none", fontSize: 16 }}>Comments</Link></a></li>
                ...
                <div style={{ width: "82%", height: "100vh", padding: 20 }}>
                    <h4>Channel Comments</h4>
                    <br />
                    <br />
                    {ChannelComments.length ? ChannelComments.map((commentdata, index) => {
                        return <div style={{ marginTop: 10, minHeight: 100, borderBottom: ".5px solid lightgrey", display: "flex", flexDirection: "row", alignItems: "center" }}>
                            <img style={{ width: 45, height: 45, borderRadius: 100, background: "black" }} />
